...
jQuery(document).ready(function ($) {
    ...
    mtdScript = {
        ...
        initSite: function () {
            ...
            $(".googleMap").css({height:325}).elegant_GoogleMap();
        ...
        topPanel: function () {
            ...
            function initTopPanel() {
                if (imgsNum === readyImg) {
                    ...
                    gwrap = topPanel.find(".gwrap").css({
                        height: '0px',
                        display: "block",
                        overflow: "visible"
                    });

                    map = $('#map-wrap').css({ 'display': 'none' });
                    ...
                    panelHandle.click(function () {
                        if (!$(this).hasClass("close")) {
                            ...
                            map.show(350, function () { panelHandle.addClass("close") });
